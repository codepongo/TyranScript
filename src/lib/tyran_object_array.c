...
struct tyran_object* tyran_object_new_array(tyran_memory_pool* object_pool, tyran_memory_pool* object_key_pool, tyran_memory_pool* value_pool, tyran_memory_pool* rb_node_pool, const struct tyran_runtime* runtime, const tyran_value* items, int count)
{
