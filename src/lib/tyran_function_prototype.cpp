...
static tyran_value* tyran_function_prototype_prototype;
...
{
	tyran_function_prototype_prototype = tyran_value_object_new();
	tyran_value_object_set_prototype(tyran_function_prototype_prototype, tyran_object_prototype);

	tyran_function_prototype = tyran_function_object_new_callback(tyran_function_prototype_constructor);
	tyran_value_object_insert_string_key(tyran_function_prototype, tyran_string_from_c_str("prototype"), tyran_function_prototype_prototype);
	tyran_value_object_set_prototype(tyran_function_prototype, tyran_object_prototype);

	tyran_value* function_call = tyran_function_object_new_callback(tyran_function_prototype_call);
	tyran_value_object_insert_string_key(tyran_function_prototype, tyran_string_from_c_str("call"), function_call);
	...
	tyran_value_object_insert_string_key(tyran_function_prototype, tyran_string_from_c_str("apply"), function_apply);
