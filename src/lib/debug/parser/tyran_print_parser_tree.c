...
void tyran_parser_node_print_helper(const char* description, tyran_parser_node** pointer_to_node, tyran_parser_node** current_root, tyran_parser_node** next_to_overwrite, int tab_count)
{
