...
int tyran_string_prototype_constructor(tyran_runtime*, tyran_value*, tyran_value* args, tyran_value* _this, tyran_value*, int is_constructor)
{
	tyran_value* str;
...
int tyran_string_prototype_char_at(tyran_runtime*, tyran_value*, tyran_value* args, tyran_value* _this, tyran_value* return_value, int)
{
...
int tyran_string_prototype_from_char_code(tyran_runtime*, tyran_value*, tyran_value* args, tyran_value*, tyran_value* return_value, int)
{
	char buf[100];
