...
void tyran_runtime_execute(tyran_runtime* runtime, const tyran_opcodes* opcodes, tyran_scope_stack* scope, tyran_value* current_scope, const tyran_value* _this, tyran_value* return_value, const tyran_runtime_callbacks* callbacks);
