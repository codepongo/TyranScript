...
void tyran_string_prototype_init(struct tyran_memory_pool* function_pool, struct tyran_memory_pool* function_object_pool, struct tyran_memory_pool* object_pool, struct tyran_memory_pool* value_pool, const struct tyran_runtime* runtime, struct tyran_value* constructor_protoype);
